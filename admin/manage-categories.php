...
?>
    ...
    <div class="container padding-top padding-content">
        <h1 class="padding-title text-center">Manage Categories</h1>
    <div class="position-absolute">
        ...
        <?php 
                        ...
                        <div class="row tb-content">
                            ...
                            <div class="col-2 align-items-center d-flex justify-content-center">
                                <?php 
                                    ...
                                    {
                                        ?>
                                            <img src="<?php echo SITEURL; ?>images/category/<?php echo $category_image; ?>" style="width: 100px;">
                                        <?php
                                    }
                                    else
                                    {
                            ...
                            <div class="col-3 btn-category">
                                ...
                                <a href="<?php echo SITEURL; ?>admin/delete-category.php?id=<?php echo $id; ?>&category_image=<?php echo $category_image; ?>" class="btn btn-danger">Delete Category</a>
                            </div>
                        </div>
                    <?php
                }
            ...
            {
                ?>
                    <div class="notice-text-failed text-center">No Category Added</div>
                <?php
            }
