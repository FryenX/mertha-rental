...
?>
    ...
    <div class="container padding-top padding-content position-relative">
        <h1 class="padding-title text-center">Add Category</h1>
            ...
            <div class="row padding-top-2">
                <div class="col-3"></div>
                    <div class="col-6 d-flex mb-3">
                        ...
                        <div class="col-sm-8">
                            <div class="d-flex">
                                <input type="text" name="name" placeholder="Category Title" class="form-control form-control-lg bg-light fs-6">
                            </div>
                        </div>
                    </div>
                <div class="col-3"></div>
    ...
    <?php 
        ...
        if(isset($_POST['submit']))
        {
            ...
            if($res==TRUE)
            {
                $_SESSION['add'] = "<div class='notice-text-success'>Category Added Successfully</div>";

                header('location:'.SITEURL.'admin/manage-categories.php');
            }
            else
            {
                $_SESSION['add'] = "<div class='notice-text-failed'>Failed To Add Cateogry, Please Try Again Later</div>";
