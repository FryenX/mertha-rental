...
?>
    ...
    <div class="container padding-top padding-content position-relative">
        <h1 class="padding-title text-center">Add Brand</h1>
            ...
            <div class="row padding-top-2">
                <div class="col-3"></div>
                    <div class="col-6 d-flex mb-3">
                        ...
                        <div class="col-sm-8">
                            <div class="d-flex">
                                <input type="text" name="name" placeholder="Brand Name" class="form-control form-control-lg bg-light fs-6">
                            </div>
                        </div>
                    </div>
                <div class="col-3"></div>
                ...
                <div class="col-3"></div>
                    <div class="col-6">
                        <div class="text-center">
                            <input class="btn btn-success" type="submit" name="submit" value="Add Brand"></input>
    ...
    <?php 
        ...
        if(isset($_POST['submit']))
        {
            ...
            if($res==TRUE)
            {
                $_SESSION['add'] = "<div class='notice-text-success'>Brand Added Successfully</div>";

                header('location:'.SITEURL.'admin/manage-brands.php');
            }
            else
            {
                $_SESSION['add'] = "<div class='notice-text-failed'>Failed To Add Brand, Please Try Again Later</div>";
