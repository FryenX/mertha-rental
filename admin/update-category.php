...
?>
    ...
    <div class="container padding-top padding-content">
        <h1 class="padding-title text-center">Update Category</h1>
        ...
        <div class="">
            <?php 
                if(isset($_GET['id']))
                {
                    ...
                    {   
                        $_SESSION['no-category-found'] = "<div class=notice-text-failed>Category Not Found.</div>";
                        ...
                        <div class="col-sm-8">
                            <div class="d-flex">
                                ...
                                <?php 
                                    ...
                                    {
                                        ?>
                                            <img src="<?php echo SITEURL; ?>images/category/<?php echo $current_image ?>" style="width: 200px;">
                                        <?php
                                    }
                                    else
                                    {
                ...
                <div class="col-3"></div>
                    <div class="col-6">
                        <div class="text-center">
                            ...
                            <input  class="btn btn-success" type="submit" name="submit" value="Update Category"></input>
    ...
    <?php 
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != "")
                {
                    ...
                    $ext = end($part);
                    $image_name = "Bike_Category_".rand(000, 999).'.'.$ext;
                ...
                if($res2 == TRUE)
                {
                    $_SESSION['update'] = "<div class='notice-text-success'>Category Updated Successfully.</div>";
                    header('location:'.SITEURL.'admin/manage-categories.php');
                }
                else
                {
                    $_SESSION['update'] = "<div class='notice-text-failed'>Failed to Update Category, Please Try Again Later.</div>";
                    header('location:'.SITEURL.'admin/manage-categories.php');
                }
            }
